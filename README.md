# LARVIO-GPU
This repository is a version of the original LARVIO implementation with GPU acceleration for the frontend part. It can run on Nvidia Jetson Nano in real-time.
